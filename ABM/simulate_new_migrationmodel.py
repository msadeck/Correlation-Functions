...
for i in range(n_sims):
    ...
    filename = f"{folder_path}/correlation_data_run2_scale_{i}_{scale_factor}.npy"
    # Save to file
...
folder_path = "../data"
# Create a unique filename for this simulation
filename = f"{folder_path}/correlation_data_run2_scale_{scale_factor}_complete.npy"
# Save to file
np.save(filename, save_data)